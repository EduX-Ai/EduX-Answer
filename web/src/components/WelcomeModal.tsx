      ...
      <div className="text-base">
        ...
        {!validModelSelected && (
          <>
            ...
            EduX&apos;s search. Different models have different strengths,
        ...
        way that EduX-answer gets data from your organization&apos;s various data
        sources. Once setup, we&apos;ll automatically sync data from your apps
        and docs into EduX-answer, so you can search all through all of them in one
        place.
        <div className="flex mt-3">
